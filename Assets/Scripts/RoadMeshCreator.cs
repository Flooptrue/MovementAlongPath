...
public class RoadMeshCreator : PathSceneTool
{
    ...
    [SerializeField, Header("Road settings")]
    ...
    [SerializeField] private float    _textureTiling = 1;
    ...
    private void AssignMaterials()
    {
        ...
        {
            _meshRenderer.sharedMaterials = new Material[] { _roadMaterial, _undersideMaterial, _undersideMaterial };
            _meshRenderer.sharedMaterials[0].mainTextureScale = new Vector3(1, _textureTiling);
        }
    }
